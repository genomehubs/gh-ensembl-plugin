...
## Begin GenomeHubs Modifications
    $header = sprintf '<span class="species">%s</span> <span class="more">(%s)</span>', $hub->species, $species, $assembly;
    ## Species selector
    $arrow     = sprintf '<span class="dropdown"><a class="toggle species" href="#" rel="species">&#9660;</a></span>';
    $dropdown  = $self->species_list;
  }

  my $content = sprintf '<span class="header"><a href="%s">%s</a> %s %s</span>', 
...
## Begin GenomeHubs Modifications
  return sprintf '<div class="dropdown species"><ul>%s</ul></div>', $all_species;  
## End GenomeHubs Modifications
}
