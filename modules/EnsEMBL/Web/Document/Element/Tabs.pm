...
#  my $sp_bar      = 
#  $long_tabs  .= qq(<li class="species long_tab" style="display:block"><a href="/Melitaea_cinxia/Info/Index?db=core;r=scaffold2194:50000-100000">Melitaea cinxia (MelCinx1.0)</a></li>);
#  $long_tabs  .= qq(<li class="species long_tab" style="display:block">$sp_bar->content()</li>);
