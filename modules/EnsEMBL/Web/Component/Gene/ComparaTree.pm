...
## BEGIN GENOMEHUBS MODIFICATIONS...
      ...
      my $_adaptor = $genome_db_adaptor->fetch_by_name_assembly($hub->species_defs->get_config($species_name, 'SPECIES_PRODUCTION_NAME'));
      my $dbid = $_adaptor->dbID if $_adaptor;
      push @{$genome_db_ids_by_clade{$clade}}, $dbid if $dbid;
